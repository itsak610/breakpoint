...
router.post("/event-status", (req, res) => {
  if (req.body.password != eventPassword) {
    return res.render("trigger", {
      ...
      eventStatus: eventIsOn,
      error:
        "Whoops! Incorrect Password. Enter a valid password or else Aliens will whisk you away.",
    });
  } else {
                ...
                transporter.sendMail(mailOptions, function (err, info) {
                  if (err)
                    ...
                    return res.render("school-register", {
                      title: "School Register",
                      error:
                        "School registered successfully. Credentials sent to your email. If you are unable to find the email, check your spam folder or contact us at cypherdps@gmail.com",
                      errorcode: "blue",
                    });
                });
            }
                  ...
                  transporter.sendMail(mailOptions, function (err, info) {
                    if (err) {
                      ...
                      return res.render("student-register", {
                        ...
                        title: "Student Register",
                        error:
                          "Student registered successfully. Credentials sent to your email. If you are unable to find the email, check your spam folder or contact us at cypherdps@gmail.com . If you wish to register for other events as well, head over to the register page and register for the desired event using the same email id.",
                        errorcode: "blue",
                        eventname: "click",
                      });
                    }
          ...
          transporter.sendMail(mailOptions, function (err, info) {
            if (err)
              ...
              return res.render("crosshair-register", {
                ...
                error:
                  "Team registered successfully. Credentials sent to your email. If you are unable to find the email, check your spam folder or contact us at cypherdps@gmail.com",
                errorcode: "blue",
              });
          });
      }
          ...
          transporter.sendMail(mailOptions, function (err, info) {
            if (err)
              ...
              return res.render("crosshair-register", {
                title: "(c)rosshair Register",
                error:
                  "Team registered successfully. Credentials sent to their emails. If you are unable to find the email, check your spam folder or contact us at cypherdps@gmail.com",
                errorcode: "blue",
              });
          });
      }
