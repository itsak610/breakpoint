...
router.post('/school/participant/register/click', function(req, res) {
    ...
    if(req.body.password != req.body.passwordConfirm){
      return res.render('click-register', { title: '(c)lick Register', error : 'The passwords dont match.'});
    }
    else{
             ...
             User.register(new User({
               ...
               time: new Date(),
                ...
                var mailOptions = {
                 ...
                 if (err) {
               return res.render('click-register', { title: '(c)lick Register', error : 'The Student has already been registered.'});
             }
             else
                 transporter.sendMail(mailOptions, function (err, info) {
                   if(err)
                     return res.render('click-register', { title: '(c)lick Register', error : 'Student registered successfully.'});
                   else 
                     return res.render('click-register', { title: '(c)lick Register', error : 'Student registered successfully. Their credentials have been sent to their emails.'});
                 });
             }
             );
        });
  ...
  router.post('/school/participant/register/clipped', function(req, res) {
    ...
    if(req.body.password != req.body.passwordConfirm){
        return res.render('clipped-register', { title: '(c)lipped Register', error : 'The passwords dont match.'});
    }
    else{
             ...
             User.register(new User({
               ...
               time: new Date(),
                ...
                var mailOptions = {
                 ...
                 if (err) {
               return res.render('clipped-register', { title: '(c)lipped Register', error : 'The Student has already been registered.', eventname: 'clipped' });
             }
             else
                 transporter.sendMail(mailOptions, function (err, info) {
                   if(err)
                     return res.render('clipped-register', { title: '(c)lipped Register', error : 'Student registered successfully.', eventname: 'clipped' });
                   else 
                     return res.render('clipped-register', { title: '(c)lipped Register', error : 'Student registered successfully. Their credentials have been sent to their emails.', eventname: 'clipped' });
                 });
             }
             );
        });
